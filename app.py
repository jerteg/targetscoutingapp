...
.block-container { padding-top: 2.2rem !important; max-width: 1060px !important; }
...
/* Open button flush under each card */
...
TOOL_GROUPS = [
    {
        ...
        "tools": [
            (
                "Ranking",
                "scout",
                "Rank players by role, custom stats and weights. Build shortlists.",
            ...
            (
                "Player Dashboard",
                "scout",
                "Full scout view: radar, scatter, similar players, squad overview.",
            ...
            (
                "Compare",
                "scout",
                "Two players side-by-side: mirrored bars, key stats, overlay radar.",
            ...
            (
                "Development",
                "track",
                "Multi-season ratings, biggest risers & fallers, player trend profiles.",
    ...
    },
    {
        ...
        "tools": [
            (
                "Radar",
                "chart",
                "Performance as a radar chart. Single player or head-to-head.",
            ...
            (
                "Player Card",
                "chart",
                "Full percentile breakdown per category. Export as HTML card.",
            ...
            (
                "Scatter Plot",
                "chart",
                "Plot two stats against each other. Highlight any player.",
    ...
    },
    {
        ...
        "tools": [
            (
                "Database",
                "data",
                "Browse all 5,500+ players. Filter by position, club, league, age.",
            ...
            (
                "Report Builder",
                "report",
                "Build a custom scout report with radar, bars, scatter and notes.",
...
for group in TOOL_GROUPS:
    for t in group["tools"]:
        pages_flat.append(t[3])

# ── Render tool groups ─────────────────────────────────────────────────────────
for group in TOOL_GROUPS:
    tools = group["tools"]
    st.markdown(
        f'<div class="tool-group-label">{group["label"]}</div>',
        unsafe_allow_html=True
    )
...
# Glossary link in footer
_, mid, _ = st.columns([2, 1, 2])
with mid:
    if st.button("📖 Glossary", key="btn_gl"):
